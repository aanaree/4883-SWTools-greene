...
//Q10
$sql ='SELECT club, wonloss, SUM(IF(STRCMP(wonloss,"won")=0, 1,0)) as Wins, SUM(IF(STRCMP(wonloss,"loss")=0, 1,0)) as Loss, SUM(IF(STRCMP(wonloss,"won")=0, 1,0))/SUM(IF(STRCMP(wonloss,"loss")=0, 1,0)) as perct 
        FROM `game_totals` GROUP BY club ORDER BY perct';
