        ...
        if gameid != "nextupdate":
            ...
            for driveid,drivedata in gamedata['drives'].items():
                ...
                if driveid != 'crntdrv':
                    for playid,playdata in drivedata['plays'].items():
                        #print(playid)
                        for playerid,playerstats in playdata['players'].items():
                            for playername in playerstats:
                                #print(playername)
                                for k,v in playername.items():
                                    if k== "playerName":
                                        if v != 'None':
                                            pname = [v]
                                            pname.sort()
...
print("Name:       Ackeem Greene\n")
print("Assignment: A03 - NFL Stats\n")
print("!3th February, 2019\n","=============================================================")
print("1: Find the Player(s) that payed for the most Teams.\n\n","Answer.\n\n")

print(pname[0], "played for ....teams\n", "=============================================================")